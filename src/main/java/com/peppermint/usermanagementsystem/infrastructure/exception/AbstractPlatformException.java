...
public class AbstractPlatformException extends RuntimeException {
    ...
    protected AbstractPlatformException(ErrorCode errorCode) {
        this.globalisationMessageCode = errorCode.getCode();
        this.defaultUserMessage = errorCode.getDefaultMessage();
        this.defaultUserMessageArgs = NO_ARGS;
    }

    protected AbstractPlatformException(ErrorCode errorCode, Throwable cause) {
        super(cause);
        this.globalisationMessageCode = errorCode.getCode();
        this.defaultUserMessage = errorCode.getValue();
        this.defaultUserMessageArgs = NO_ARGS;
    }
